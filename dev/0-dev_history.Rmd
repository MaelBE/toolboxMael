...
fusen::fill_description(
  pkg = here::here(),
  fields = list(
    Title = "Créer une boite à outils",
    Description = "Un ensemble de fonction pour lister et manipuler son envrionnement.",
    `Authors@R` = c(
      person("Maël", "BEAUFORT", email = "mael.beaufort@atih.sante.fr", role = c("aut", "cre"), comment = c(ORCID = "0000-0000-0000-0000"))
    )
  )
)
# Define License with use_*_license()
usethis::use_mit_license("Maël BEAUFORT")
```
